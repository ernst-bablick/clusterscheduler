...
#define MSG_GDI_WRONG_GDI_SSISS  _MESSAGE(33115, _("denied: client (" SFN "/" SFN "/%d) uses GDI version " SFN " while qmaster uses version " SFN))
#define MSG_GDI_WRONG_GDI_SSIUS  _MESSAGE(33116, _("denied: client (" SFN "/" SFN "/%d) uses GDI version 0x" sge_X32CFormat " while qmaster uses version " SFN))
...
#define MSG_JOB_MASTERSLAVENONPE      _MESSAGE(33209, _("job rejected: specification of master or slave specific requests is not allowed for non-parallel jobs"))
...
#define MSG_JOB_SLAVEPERJOBREQUEST_S  _MESSAGE(33214, _("job rejected: requesting per job consumable " SFQ " for slave tasks does not make sense"))
#define MSG_JOB_PERHOSTINBOTHMASTERSLAVE_S _MESSAGE(33215, _("job rejected: per host consumable " SFQ " both as master and slave request is not allowed"))
#define MSG_JOB_CKPTMINUSC            _MESSAGE(33216, _("job rejected: checkpointing with \"-c n\" requested"))
...
#define MSG_JOB_MASTERSLAVESOFTQUEUE  _MESSAGE(33230, _("job rejected: specification of master or slave specific soft queue requests is not allowed"))
#define MSG_JOB_MASTERSLAVESOFTREQ    _MESSAGE(33231, _("job rejected: specification of master or slave specific soft resource requests is not allowed"))
...
#define MSG_CONF_NAMEISNULLINCONFIGURATIONLISTOFX_S   _MESSAGE(33548, _("name == nullptr in configuration list of " SFQ))
#define MSG_CONF_VALUEISNULLFORATTRXINCONFIGURATIONLISTOFY_SS _MESSAGE(33549, _("value == nullptr for attribute " SFQ " in configuration list of " SFQ))
